                  ...
                  <div class="form-row">
                      <div class="form-element">
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="commercialName" autocomplete="commercialName" />
                          </div>
                          <div class="form-element-label">
                              <label>
                                  Nombre fiscal
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="fiscalName" autocomplete="fiscalName" />
                          </div>
                          <div class="form-element-label">
                              <label>
                                  Dirección comercial
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="commercialAddress" autocomplete="commercialAddress" />
                          </div>
                          <div class="form-element-label">
                              <label>
                                  Dirección fiscal
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="fiscalAddress" autocomplete="fiscalAddress" />
                          </div>
                          <div class="form-element-label">
                              <label>
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="vatNumber" autocomplete="vatNumber" />
                          </div>
                      </div>
                  </div>         
                </div>
...
customElements.define('company-form-component', Company)
