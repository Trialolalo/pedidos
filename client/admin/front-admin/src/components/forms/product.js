...
class Product extends HTMLElement {
  ...
  async connectedCallback () {
    ...
    const response = await fetch('/api/admin/product-categories/get-categories')
                  ...
                  <div class="form-row">
                    <div class="form-element">
                      ...
                      <div class="form-element-input">
                          <input  type="text" class="validate" name="name" autocomplete="name" />
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-element">
                      ...
                      <div class="form-element-input">
                          <input  type="text" class="validate" name="reference" autocomplete="reference" />
                      </div>
                    </div>
                    <div class="form-element">
                      <div class="form-element-label">
                      ...
                      <div class="form-element-input">
                          <input type="number" class="validate" name="price.basePrice" autocomplete="measurement" />
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-element">
                      ...
                      <div class="form-element-input">
                          <input  type="text" class="validate" name="measurementUnit" autocomplete="measurementUnit" />
                      </div>
                    </div>
                    <div class="form-element">
                      <div class="form-element-label">
                      ...
                      <div class="form-element-input">
                          <input type="number" class="validate" name="measurement" autocomplete="measurement" />
                      </div>
                    </div>
                    <div class="form-element">
                      <div class="form-element-label">
                      ...
                      <div class="form-element-input">
                          <input  type="number" class="validate" name="units" autocomplete="units" />
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-element">
                      ...
                      <div class="form-element-input">
                          <select name="productCategoryId">
                            <option value="-1" selected disabled>Categoría de producto</option>
                          </select>
                      </div>
                    </div>
                    <div class="form-element">
                      ...
                      <div class="form-element-input">
                        <input class="validate" name="visible" type="checkbox" />
                      </div>
                    </div>
                  </div>         
                </div>
...
customElements.define('product-form-component', Product)
